  ...
  public void Query6()
    {
      ...
      CondExpr [] outFilter  = new CondExpr[3];
      outFilter[0] = new CondExpr(); // ID equivalency
      outFilter[1] = new CondExpr(); // greater  
      outFilter[2] = new CondExpr();   // --> null
      CondExpr [] outFilter2 = new CondExpr[3];
      outFilter2[0] = new CondExpr();  // BID equivalency
      outFilter2[1] = new CondExpr();	// color = red
      outFilter2[2] = new CondExpr();  // --> null
